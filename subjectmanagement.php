...
<body>
	...
	<div class="container">
        ...
        <input type="checkbox" name="subject[]" value="malayalam"> malayalam<br>
        ...
        <input type="checkbox" name="subject[]" value="socialscience">ocialscience <br>
              ...
              <div class="form-group">
							...
							<button type="submit" class="btn btn-two" name="submit">Add</button><p><br/></p>
						</form>
					</div>
