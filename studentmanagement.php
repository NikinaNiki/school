...
mysqli_query($con,"INSERT INTO studentreg(name,dob,gender,email,phone,address,class,division,file)VALUES('$name','$dob','$gender','$email','$phone','$address','$class','$division','$filename')");
