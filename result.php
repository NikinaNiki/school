...
<tr>
    ...
    <tr>
        ...
        <td>50 </td>
            ...
            <td><?php echo $row['english'];?></td>
                <td><?php if($row['english']>=45&& $row['english']<=50  )
                 {
                    echo "A+";
                 }
                 else if($row['english']>=40&&$row['english']<45 )
                 {
                    echo "A";
                 }
                 else if($row['english']>=35 &&$row['english']<40)
                 {
                    echo "B+";
                 }
                 else if($row['english']>=30&&$row['english']<35)
                 {
                    echo "B";
                 }
                 else if($row['english']>=25 &&$row['english']<30) 
                 {
                    echo "c+";
                 }
                 else if($row['english']>=20 &&$row['english']<25)
                 {
                    echo "c";
                 }
                 else if($row['english']>=15 &&$row['english']<20)
                 {
                    echo "D+";
                 }
                 else if($row['english']>=10 &&$row['english']<15)
                 {
                    echo "D";
                 }
                 else if($row['english']>=5 &&$row['english']<10)
                 {
                    echo "E+";
                 }
                 else if($row['english']>=0 &&$row['english']<5)
                 {
                    echo "E";
                 }
                ;?>
    ...
    <tr>
        ...
        <td>50 </td>
            ...
            <td><?php if($row['hindi']>=45&& $row['hindi']<=50  )
                 {
                    echo "A+";
                 }
                 else if($row['hindi']>=40&&$row['hindi']<45 )
                 {
                    echo "A";
                 }
                 else if($row['hindi']>=35&&$row['hindi']<40)
                 {
                    echo "B+";
                 }
                 else if($row['hindi']>=30&&$row['hindi']<35)
                 {
                    echo "B";
                 }
                 else if($row['hindi']>=25 &&$row['hindi']<30) 
                 {
                    echo "c+";
                 }
                 else if($row['hindi']>=20 &&$row['hindi']<25)
                 {
                    echo "c";
                 }
                 else if($row['hindi']>=15 &&$row['hindi']<20)
                 {
                    echo "D+";
                 }
                 else if($row['hindi']>=10 &&$row['hindi']<15)
                 {
                    echo "D";
                 }
                 else if($row['hindi']>=5 &&$row['hindi']<10)
                 {
                    echo "E+";
                 }
                 else if($row['hindi']>=0 &&$row['hindi']<5)
                 {
                    echo "E";
                 }
                ;?>
    ...
    <tr>
        ...
        <td>50 </td>
            ...
            <td><?php if($row['malayalam']>=45 && $row['malayalam']<=50  )
                 {
                    echo "A+";
                 }
                 else if($row['malayalam']>=40&&$row['malayalam']<45 )
                 {
                    echo "A";
                 }
                 else if($row['malayalam']>=35&&$row['malayalam']<40)
                 {
                    echo "B+";
                 }
                 else if($row['malayalam']>=30&&$row['malayalam']<35)
                 {
                    echo "B";
                 }
                 else if($row['malayalam']>=25 &&$row['malayalam']<30) 
                 {
                    echo "c+";
                 }
                 else if($row['malayalam']>=20 &&$row['malayalam']<25)
                 {
                    echo "c";
                 }
                 else if($row['malayalam']>=15 &&$row['malayalam']<20)
                 {
                    echo "D+";
                 }
                 else if($row['malayalam']>=10 &&$row['malayalam']<15)
                 {
                    echo "D";
                 }
                 else if($row['malayalam']>=5 &&$row['malayalam']<10)
                 {
                    echo "E+";
                 }
                 else if($row['malayalam']>=0 &&$row['malayalam']<5)
                 {
                    echo "E";
                 }
                ;?>
    ...
    <tr><td>science</td>
        <td>50 </td>
            ...
            <td><?php if($row['science']>=45&& $row['science']<=50  )
                 {
                    echo "A+";
                 }
                 else if($row['science']>=40&&$row['science']<45 )
                 {
                    echo "A";
                 }
                 else if($row['science']>=35&&$row['science']<40)
                 {
                    echo "B+";
                 }
                 else if($row['science']>=30&&$row['science']<35)
                 {
                    echo "B";
                 }
                 else if($row['science']>=25 &&$row['science']<30) 
                 {
                    echo "c+";
                 }
                 else if($row['science']>=20 &&$row['science']<25)
                 {
                    echo "c";
                 }
                 else if($row['science']>=15 &&$row['science']<20)
                 {
                    echo "D+";
                 }
                 else if($row['science']>=10 &&$row['science']<15)
                 {
                    echo "D";
                 }
                 else if($row['science']>=5 &&$row['science']<10)
                 {
                    echo "E+";
                 }
                 else if($row['science']>=0 &&$row['science']<5)
                 {
                    echo "E";
                 }
                ;?>
        ...
        <td>50 </td>
            ...
            <td><?php if($row['maths']>=45&& $row['maths']<=50  )
                 {
                    echo "A+";
                 }
                 else if($row['maths']>=40&&$row['maths']<45 )
                 {
                    echo "A";
                 }
                 else if($row['maths']>=35&&$row['maths']<40)
                 {
                    echo "B+";
                 }
                 else if($row['maths']>=30&&$row['maths']<35)
                 {
                    echo "B";
                 }
                 else if($row['maths']>=25 &&$row['maths']<30) 
                 {
                    echo "c+";
                 }
                 else if($row['maths']>=20 &&$row['maths']<25)
                 {
                    echo "c";
                 }
                 else if($row['maths']>=15 &&$row['maths']<20)
                 {
                    echo "D+";
                 }
                 else if($row['maths']>=10 &&$row['maths']<15)
                 {
                    echo "D";
                 }
                 else if($row['maths']>=5 &&$row['maths']<10)
                 {
                    echo "E+";
                 }
                 else if($row['maths']>=0 &&$row['maths']<5)
                 {
                    echo "E";
                 }
                ;?>
