...
$id=$_GET['id'];
$data=mysqli_query($con,"select * from staffreg where id='$id'");
$row=mysqli_fetch_assoc($data);
$data1=mysqli_query($con,"select * from login where id='$id' and type='staff'");
...
mysqli_query($con,"update staffreg set name='$name' ,dob='$dob', gender='$gender',email='$email',phone='$phone',address='$address',file='$filename' where id='$id'");
