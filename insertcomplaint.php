...
mysqli_query($con,"INSERT INTO complaint(complaint,date,Student_id)VALUES('$complaint','$date','$student_id')");
				...
				<div class="row">
					<div class="col-md-8">
						...
						<form class="form-light mt-20" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
								<label>Date</label>
								<input type="date" class="form-control" placeholder="Your name" name="date">
							</div>
              <div>
              <label for="exampleInputUsername1"></label>
                      <input type="hidden" name="id" value="<?php echo ($row['id'])?>"
                      class="form-control" id="" placeholder="complaint">
                    </div>           
